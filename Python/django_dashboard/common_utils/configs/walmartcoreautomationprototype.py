...
# WalmartCoreAutomationProtoType Project class.
# Do not modify.
class WalmartCoreAutomationProtoTypeProject(Project):
    project_id = 32
...
class WalmartCoreAutomationProtoTypeCommon(WalmartCoreAutomationProtoTypeProject, Config):
    common = set()


# Automation Type Configs
# Add classes below by deriving from (1) WalmartCoreAutomationProtoTypeCommon class, and (2) the corresponding automation type class.
# -----------------------
