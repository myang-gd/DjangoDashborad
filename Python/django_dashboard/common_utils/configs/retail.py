...
# Retail Project class.
# Do not modify.
class RetailProject(Project):
    project_id = 24
...
class RetailCommon(RetailProject, Config):
    common = set()


# Automation Type Configs
# Add classes below by deriving from (1) RetailCommon class, and (2) the corresponding automation type class.
# -----------------------
